Um zu zeigen, dass $V = \{x \in E : h(x) = 0\}$ ein Unterraum von $E$ ist, müssen wir nachweisen, dass $V$ die folgenden Eigenschaften erfüllt:

1. Das Null-Element von $E$ gehört zu $V$.
2. $V$ ist abgeschlossen unter Addition.
3. $V$ ist abgeschlossen unter skalaren Multiplikationen.
