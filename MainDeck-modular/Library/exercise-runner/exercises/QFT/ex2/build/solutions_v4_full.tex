...
\paragraph{Lösung.}
Um die Beziehung $\epsilon^{\prime \alpha \beta} = - \epsilon^{\alpha \beta}$ zu zeigen, betrachten wir die Bedingung für die Inverse der Lorentztransformation. Die Transformationen sind gegeben durch:
...
%CHECK: Die Herleitung der Inversenbedingung wurde explizit auf die Terme erster Ordnung reduziert. Die Transformation der Normerhaltung wurde klarer dargestellt, indem die Terme erster Ordnung isoliert wurden.

\section*{Aufgabe 5 [v4]}
\subsection*{(5.1) [v4]}
\paragraph{Aufgabentext.}
