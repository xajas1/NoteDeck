...
\[
m_Z^2 c^4 = 2 \gamma m_e^2 c^4 + 2 \gamma m_e^2 c^4 \left(1 - \frac{v^2}{c^2}\right)
\]

Da \( m_Z \gg m_e \), ist die Näherung \( \gamma \approx \frac{m_Z^2}{2 m_e^2} \) nicht direkt anwendbar. Stattdessen verwenden wir die Näherung:

\[
\gamma \approx \frac{m_Z}{m_e}
\]

Diese Näherung ergibt sich, weil der quadratische Term \( m_Z^2 \) im Vergleich zu \( 2 m_e^2 \) dominiert. Setzen wir die Werte ein:
