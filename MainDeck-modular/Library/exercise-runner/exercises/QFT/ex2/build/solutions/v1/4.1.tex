...
\[
x^\alpha = \delta^\alpha_\gamma x^\gamma = x^\alpha.
\]
...
Für infinitesimale $\epsilon^{\alpha \beta}$ und $\epsilon^{\prime \alpha \beta}$ können wir die Terme erster Ordnung betrachten:
...
Dies impliziert, dass $\epsilon^{\prime \alpha \beta} = - \epsilon^{\alpha \beta}$.
