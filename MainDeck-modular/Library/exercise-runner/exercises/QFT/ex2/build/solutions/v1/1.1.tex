...
\[
m_Z c^2 = \sqrt{2 \gamma m_e c^2 \cdot m_e c^2}
\]

\[
m_Z^2 = 2 \gamma m_e^2 c^4
\]

\[
\gamma = \frac{m_Z^2}{2 m_e^2 c^4}
\]

Da \( m_Z \gg m_e \), ist \( \gamma \approx \frac{m_Z}{m_e} \). Setzen wir die Werte ein:
