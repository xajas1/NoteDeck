...
Für massive Teilchen (\(m \neq 0\)) ist die Helizität nicht mehr eine wohldefinierte Erhaltungsgröße, da die Masse einen Wechsel zwischen linkshändigen und rechtshändigen Komponenten ermöglicht. Daher sind die Spinoren \(P_{L, R} u_s(p)\) im Allgemeinen keine Eigenzustände des Helizitätsoperators mit festen Eigenwerten \(\pm \frac{1}{2}\).