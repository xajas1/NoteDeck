...
\[
1 \, \text{kg} = \frac{1 \, \text{kg} \cdot (3 \times 10^8 \, \text{m/s})^2}{1.602 \times 10^{-19} \, \text{J/GeV}} \approx 5.61 \times 10^{26} \, \text{GeV}
\]
...
\[
1 \, \text{s} = \frac{1 \, \text{s}}{6.582 \times 10^{-25} \, \text{s/GeV}} \approx 1.52 \times 10^{24} \, \frac{1}{\mathrm{GeV}}
\]
...
\[
M_{pl} = \frac{1}{\sqrt{6.71 \times 10^{-39} \, \text{GeV}^{-2}}} \approx 1.22 \times 10^{19} \, \text{GeV}
\]