...
mit konstanten \(a, b\), was offensichtlich eine glatte Funktion ist, da die Ableitungen aller Ordnungen konstant sind und somit existieren. Insbesondere sind die Übergangsfunktionen zwischen den Karten von der Form

\[
f_{ij}(x,y) = (x + m_{ij}, y + n_{ij})
\]

wobei \(m_{ij}, n_{ij} \in \mathbb{Z}\) die notwendigen Translationen zwischen den Karten \(U_i\) und \(U_j\) sind.
