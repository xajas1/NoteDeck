...
(H2.1.1.) What familiar space is the quotient $\Delta$-complex of a 2 -simplex $\left[v_0, v_1, v_2\right]$ obtained by identifying the edges $\left[v_0, v_1\right]$ and $\left[v_1, v_2\right]$, preserving the ordering of vertices?
