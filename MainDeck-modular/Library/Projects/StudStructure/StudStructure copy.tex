...
% 18  Extra
% 00. Titel und Autor
\usepackage{xparse,calc,graphicx}

% absoluter Root-Pfad (passt zu deinem System)
\newcommand{\ArtRoot}{/Users/tim/NoteDeck/MainDeck-modular/Library/Images/}

% --- art_index.tex sicher laden: @ erlauben, _/#/% als normale Zeichen behandeln
\begingroup
  \makeatletter
  \catcode`\_=12  % _ als normales Zeichen (kein Subscript)
  \catcode`\#=12  % # als normales Zeichen
  \catcode`\%=12  % % als normales Zeichen (kein Kommentar)
  \input{/Users/tim/NoteDeck/MainDeck-modular/Library/Images/Art/art_index.tex}
\endgroup

% Wrapper, damit du keine @-Namen schreiben musst
\makeatletter
\newcommand{\artpath}[1]{\ArtRoot\csname artpath@#1\endcsname}
\newcommand{\artcap}[1]{\csname artcap@#1\endcsname}
\makeatother
...
\graphicspath{{../../Images/}{../../Images/Art/../}}
...
\StructurePic{\artpath@ART0003}{\artcap@ART0003}{
  Hier kommt dein Beweistext hin …
}
...
\StructurePic{ART0589__Paul_Klee__Stricken_City__1936.jpg}{}
{%
\begin{outline}
