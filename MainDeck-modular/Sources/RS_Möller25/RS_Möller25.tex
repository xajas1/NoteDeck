...
Die komplexe Ebene $\mathbb{C}$, die obere Halbebene $\mathbb{H}=\{z \in \mathbb{C}$ : $\operatorname{Im}(z)>0\}$ und die Einheitskreisscheibe $\triangle=\{z:|z|<1\}$ sind Riemannsche Flächen, gegeben durch eine Karte, ebenso $\mathbb{C}^{*}=\mathbb{C} \backslash\{0\}$ und $\triangle^{*}=\triangle \backslash\{0\}$ die punktierte Ebene (bzw. punktierte Einheitskreisscheibe).
...
\begin{figure}[h]
\begin{center}
  \includegraphics[scale=0.2]{2025_10_06_374d4cfa8b1948eb4c41g-019}
