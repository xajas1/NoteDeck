...
\begin{DEF}{FA-W25-01-01}{Halbnorm, Norm und normierter Raum}
...
\begin{DEF}{FA-W25-01-02}{Äquivalenzrelation zwischen Halbnormen}
...
\begin{EXA}{FA-W25-01-03}{Äquivalenz von Normen in endlichdimensionalen Räumen}
...
\begin{EXA}{FA-W25-01-04}{$p$-Normen auf $\mathbb{K}^N$}
...
\begin{EXA}{FA-W25-01-05}{$\ell^\infty(M,\mathbb{K})$ mit Supremumsnorm}
...
\begin{DEF}{FA-W25-01-06}{Konvexität, Symmetrie und absolute Konvexität}
Sei $E$ ein $\mathbb{K}$-Vektorraum, wobei $\mathbb{K}\in\{\mathbb{R},\mathbb{C}\}$.
...
\begin{PROP}{FA-W25-01-07}{Elementare Eigenschaften zu (absolut) konvexen Mengen und konvexen Funktionen}
...
\begin{PROOF}{FA-W25-01-08}{P: Elementare Eigenschaften zu (absolut) konvexen Mengen und konvexen Funktionen}
...
\begin{EXA}{FA-W25-01-09}{Induzierte Halbnorm auf Vektorraum durch absorbierende und absolut konvexe Menge}
...
\begin{EXA}{FA-W25-01-10}{$\ell^{p}(\mathbb{N}, \mathbb{K}$ als normierter Vektorraum bzgl $p$-Norm}
...
Analog definiert man $\ell^{p}(I, \mathbb{K})$ für eine beliebige höchstens abzählbare Indexmenge $I$ anstelle von $\mathbb{N}$, z. B. $I=\mathbb{Z}$. Kurzschreibweisen: $\ell^{p}(I)$ statt $\ell^{p}(I, \mathbb{K})$
$$
