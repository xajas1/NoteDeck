...
\begin{DEF}{EFT1-K25a-02-01}{Lokale triviale Faserung mit typischen Fasern auf Mfk}
...
\begin{DEF}{EFT1-K25a-02-02}{Vektorraumbündel}
...
\begin{EXA}{EFT1-K25a-02-03}{Projektion von Kreuzprodukt ist eine lokal triviale Faserung}
$p r_{1}: U \times F \rightarrow U$ ist eine lokal triviale Faserung.
\end{EXA}


\begin{EXA}{EFT1-K25a-02-04}{Tangentialbündel mit differenzierbarer Struktur ist Vektorraumbündel}
...
\begin{EXA}{EFT1-K25a-02-05}{Vektorraumbündel zu $S^1$}
...
\begin{EXA}{EFT1-K25a-02-06}{Lokale triviale Faserung über $S^1$}
...
\begin{DEF}{EFT1-K25a-02-07}{Lokale triviale Faserung als Tripel von Totalraum, Basisraum, Bündelprojektion mit typischen Fasern}
...
\begin{DEF}{EFT1-K25a-02-08}{Reale Fasern in lokal trivialen Faserungen}
Für jedes $x \in M$ heißt $E_{x}=\pi^{-1}(x)$ reale Faser an der Stelle $x$.
\end{DEF}

\begin{DEF}{EFT1-K25a-02-09}{Bündelkarten für offene Teilmengen der Basis}
Für $U \subset M$ offen heißt $\varphi: E \mid U \rightarrow U \times F$ Bündelkarte
\end{DEF}


\begin{DEF}{EFT1-K25a-02-10}{Bündelatlas für lokale triviale Faserungen}
$$
...
\begin{DEF}{EFT1-K25a-02-11}{Faserkarte am Punkt x im Basisraum}
Die Abbildung $\varphi_{x}: E_{x} \rightarrow F, \varphi_{x}:=p r_{2} \circ \varphi \mid E_{x}$ heißt Faserkarte.
\end{DEF}

\begin{DEF}{EFT1-K25a-02-12}{Bündelkartenwechsel zwischen Bündelkarten}
...
\begin{DEF}{EFT1-K25a-02-13}{G-Faserbündel mit Liegruppen als Strukturgruppen}
...
\begin{DEF}{EFT1-K25a-02-14}{Prinzipalbüdel / Hauptfaserbündel}
...
\begin{REM}{EFT1-K25a-02-15}{Beziehung zwischen Vektorraumbündeln und GL-Faserbündeln}
...
\begin{DEF}{EFT1-K25a-02-16}{(Differenzierbare) (Lokale) Schnitte in lokal trivialen Faserungen}
...
\begin{DEF}{EFT1-K25a-02-17}{Raum der differenzierbaren lokalen Schnitte}
$\Gamma(M \times F)=\left\{\sigma: M \rightarrow M \times F \mid \sigma(x)=(x, f(x)), f \in C^{\infty}(M, F)\right\} \cong$ $C^{\infty}(M, F)$.
\end{DEF}\\

\begin{EXA}{EFT1-K25a-02-18}{Raum der diff. lokalen Schnitte in Kreuzprodukten}
$\Gamma T M=\{$ differenzierbare Vektorfelder auf $M\}$.
\end{EXA}\\

\begin{EXA}{EFT1-K25a-02-19}{Raum der diff. Lokalen Schnitte im Tangentialbündel}
...
\begin{EXA}{EFT1-K25a-02-21}{Im Tangentialbündel existiert kein diff. Schnitt, der nirgends verschwindet}
...
\begin{DEF}{EFT1-K25a-02-27}{Präbündel mit Strukturgruppe G zu Liegruppe G, Mfk, (disj) Vereinigung von punktweise Mfk und Projektion}
...
\subsection*{1.9 Satz}
\begin{PROP}{EFT1-K25a-02-28}{Für Präbündel $(E,\pi,M)$ existiert auf E genau einem Topologie und differenzierbare Struktur, sodass $(E,\pi,M)$ ein Faserbündel mit Strukturgruppe G wird und Präbündelkarten Bündelkarten werden}
...
\begin{EXA}{EFT1-K25a-02-29}{Bündelstruktur von Tangentialbündel als Ergebnis der Konstruktion von Präbündeln}
Die Bündelstruktur $T M$ wurde wie in Satz 1.9 definiert.
\end{EXA}


\begin{EXA}{EFT1-K25a-02-30}{Präbündel zum GL-Prinzipalbündel}
...
\begin{EXA}{EFT1-K25a-02-31}{Präbündel zum $O(n)$-Prinzipalbündel für Riemannische Mfk}
...
\begin{KORO}{EFT1-K25a-02-32}{Direkte Summe von Vektorraumbündeln ergeben Prävektorraumbündel}
...
\begin{EXA}{EFT1-K25a-02-33}{Hom-Raum für Homomorphismen zwischen Vektorraumbündeln sind Vektorraumbündel}
Sind $E, F$ Vektorraumbündel, so auch

$\operatorname{Hom}(E, F)=\bigcup_{x \in M} \operatorname{Hom}\left(E_{x}, F_{x}\right)$.
\end{EXA}

\begin{EXA}{EFT1-K25a-02-34}{Mult}
$\operatorname{Mult}^{k}(E, F)$.
\end{EXA}\\

\begin{EXA}{EFT1-K25a-02-35}{Sym}
$\operatorname{Sym}^{k}(E)$.
\end{EXA}\\

\begin{EXA}{EFT1-K25a-02-36}{Alt}
...
\begin{DEF}{EFT1-K25a-02-37}{Bündelmetrik auf Totalraum ist ein Schnitt in $Sym^2(E)$, sodass g pw. positiv definit }
...
\begin{EXA}{EFT1-K25a-02-38}{Riemannische Metrik als Bündelmetrik im Tangentialbündel}
Eine Riemannsche Metrik auf $M$ ist eine Bündelmetrik auf $T M$.
\end{EXA}


\begin{EXA}{EFT1-K25a-02-39}{$\Gamma (Alt^k(TM))$}
...
\begin{DEF}{EFT1-K25a-02-40}{Vektorraumbündel vom endlichen Typ}
...
\begin{EXA}{EFT1-K25a-02-41}{Tangentialbündel von $S^n$ ist von endlichem Typ}
...
\begin{DEF}{EFT1-K25a-02-43}{Bündelisomorphismus}
...
\begin{DEF}{EFT1-K25a-02-44}{Trivialisierung von Totalraum}
Ein Bündelisomorphismus $f: E \rightarrow B \times F$ heißt eine Trivialisierung von $E$.
\end{DEF}


\begin{DEF}{EFT1-K25a-02-45}{Vektorraumbündelabbildung über diff. Abbildungen zwischen Vektorraumbündeln}
...
\begin{DEF}{EFT1-K25a-02-46}{Vektorraumbündelisomorphismus}
...
\begin{EXA}{EFT1-K25a-02-47}{Differential von glatten Abbildungen zw. Tangentialbündel von Mfk ist eine Vektorraumbündelabbildung über glatte Abbildung $f$}
...
\begin{DEF}{EFT1-K25a-02-48}{Induzierte Bündel durch Abbildungen}
...
\begin{PROP}{EFT1-K25a-02-49}{Schnitte in induzierten Bündeln längs $f$}
Ist $f: N \rightarrow M$ eine differenzierbare Abbildung, $E \rightarrow M$ ein Faserbündel mit Strukturgruppe $G$, so ist
$$
p r_{1}: f^{*} E=\left\{(x, e) \mid x \in N, e \in E_{f(x)}\right\} \rightarrow N
$$
...
\begin{EXA}{EFT1-K25a-02-50}{Menge der Vektorfelder längs Kurven}
...
\begin{EXA}{EFT1-K25a-02-51}{Vektorraumbündel bzgl Grassmann-Mfk}
...
\begin{REM}{EFT1-K25a-02-52}{Bündelabbildungen bzgl induzierte Bündel}
...
\begin{DEF}{EFT1-K25a-02-54}{Induzierte Bündel bei Einbettungen von UnterMfk}
...
\begin{DEF}{EFT1-K25a-02-55}{Untervektorraumbündel}
...
\begin{REM}{EFT1-K25a-02-56}{Untervektorraumbündel sind Vektorraumbündel}
Ein $m$-dimensionales Untervektorraumbündel ist offenbar ein $m$-dimensionales Vektorraumbündel.
\end{REM}


\begin{REM}{EFT1-K25a-02-57}{Quotienten-Räume bzgl Untervektorraumbündel sind Vektorraumbündel}
Ist $E_{0} \subset E$ ein Untervektorraumbündel, so ist $E / E_{0}$ ein Vektorraumbündel.
\end{REM}

\begin{REM}{EFT1-K25a-02-58}{Untervektorraumbündel bzgl Bündelmetrik}
...
\begin{REM}{EFT1-K25a-02-59}{Tangentialbündel von UnterMfk sind Untervektorraumbündel}
...
\begin{REM}{EFT1-K25a-02-60}{Normalenbündel von UnterMfk}
...
\begin{PROP}{EFT1-K25a-02-61}{Rang-Satz für Vektorraumhomomorphismen: Konstanter Rang impliziert ker und im sind Untervektorraumbündel}
...
\begin{KORO}{EFT1-K25a-02-62}{Charakterisierung von Vektorraumbündeln von endlichem Typ}
...
\begin{DEF}{EFT1-K25a-02-63}{Reduktionen von Faserbündeln mit Strukturgruppe bzgl abgeschlossener Untergruppe}
...
\begin{EXA}{EFT1-K25a-02-64}{Charakterisierung von orientierten Mfk}
...
\begin{PROP}{EFT1-K25a-02-65}{Ehresmannscher Faserungssatz: Totalräume mit eigentlich regulären Abbildungen in zusammenhängenden Basisraum implizieren eine lokale triviale Faserung}
